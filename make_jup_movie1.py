#This code aims to display the calculated positions of Jupiter in an epoch around(before and after) the observation time in a stationary image.
...
for i in range(len(src_ra)):
	fig=aplpy.FITSFigure('/home/trina/Desktop/2_1068235576_I.fits')
